function [w, theta, iter, avgTol, hasError] = graphlasso(Sigma, lambda, ...
...
[w, theta, iter, avgTol, hasError] = glasso(numVars, Sigma, 0, lambda, approximate, warmInit, verbose, penalDiag, tolThreshold, maxIter, w, theta);
