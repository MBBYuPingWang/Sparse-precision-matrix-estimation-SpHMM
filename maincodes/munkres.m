function [assignment,assign_cost,cost_matrix] = munkres(costMat)
...
cost_matrix = costMat(assignment>0,assignment(assignment>0));
assign_cost = diag(costMat(assignment>0,assignment(assignment>0)));
